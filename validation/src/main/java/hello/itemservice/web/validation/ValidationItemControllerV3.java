...
public class ValidationItemControllerV3 {
    ...
    @PostMapping("/add")
    public String addItemV2(@Validated(SaveCheck.class) //groups 적용 - @Validated 어노테이션만 지원
                            //groups 기능 사용 시 등록과 수정 시 각각 다르게 검증할 수 있다. 하지만 전반저으로 복잡도가 올라간다
    ...
    @PostMapping("/{itemId}/edit")
    public String editV2(@PathVariable Long itemId, @Validated(UpdateCheck.class) ////groups 적용
                         @ModelAttribute Item item, BindingResult bindingResult) {
